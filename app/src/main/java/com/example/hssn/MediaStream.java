...
import com.example.hssn.rtp.AbstractPacketizer;
...
public abstract class MediaStream implements Stream {
	 ...
	 * {@link VideoStream#setVideoQuality(com.example.hssn.video.VideoQuality)}
	 * for a {@link VideoStream} and {@link AudioStream#setAudioQuality(com.example.hssn.audio.AudioQuality)}
	...
	/**
	 * Returns the SSRC of the underlying {@link com.example.hssn.rtp.RtpSocket}.
	...
	protected void createSockets() throws IOException {
		...
		if (sPipeApi == PIPE_API_LS) {
			...
			final String LOCAL_ADDR = "com.example.hssn-";
