...
package com.example.hssn;

import java.io.IOException;
import java.net.InetAddress;
import java.net.UnknownHostException;
import java.util.concurrent.CountDownLatch;
import com.example.hssn.audio.AudioQuality;
import com.example.hssn.audio.AudioStream;
import com.example.hssn.exceptions.CameraInUseException;
import com.example.hssn.exceptions.ConfNotSupportedException;
import com.example.hssn.exceptions.InvalidSurfaceException;
import com.example.hssn.exceptions.StorageUnavailableException;
import com.example.hssn.gl.SurfaceView;
import com.example.hssn.rtsp.RtspClient;
import com.example.hssn.video.VideoQuality;
import com.example.hssn.video.VideoStream;
...
public class Session {
	...
	public Session() {
		...
		HandlerThread thread = new HandlerThread("com.example.hssn.Session");
		thread.start();
