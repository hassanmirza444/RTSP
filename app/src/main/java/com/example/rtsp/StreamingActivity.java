...
public class StreamingActivity extends Activity implements
    ...
    public void toggleStream() {
        ...
        if (!mClient.isStreaming()) {
           ...
           // editor.putString("uri", "rtmps://live.onestream.studio:19350/live");
            ...
            Matcher m = uri.matcher("rtsp://f53cf08c0fc6.entrypoint.cloud.wowza.com:1935/app-47hc3626/10d9a3e9");
            m.find();
            ip = m.group(1);
            port = m.group(2);
            path = m.group(3);
